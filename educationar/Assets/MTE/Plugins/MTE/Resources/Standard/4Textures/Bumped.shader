Shader "MTE/Standard/4 Textures/Bumped"
{
	...
	CGINCLUDE
		...
		void MTE_SplatmapMix(Input IN, half4 defaultAlpha, out half4 splat_control, out half weight, out fixed4 mixedDiffuse, out fixed3 mixedNormal)
		{
		...
		void surf(Input IN, inout SurfaceOutputStandard o)
		{
			...
			fixed3 mixedNormal;
			MTE_SplatmapMix(IN, defaultSmoothness, splat_control, weight, mixedDiffuse, mixedNormal);
