Shader "MTE/Standard/5 Textures/Bumped/NoFog"
{
	...
	CGINCLUDE
		...
		void MTE_SplatmapMix(Input IN, half4 defaultAlpha, out half4 splat_control, out half4 splat_control_extra, out half weight, out fixed4 mixedDiffuse, out fixed3 mixedNormal)
		{
		...
		void surf(Input IN, inout SurfaceOutputStandard o)
		{
			...
			fixed3 mixedNormal;
			MTE_SplatmapMix(IN, defaultSmoothness, splat_control, splat_control_extra, weight, mixedDiffuse, mixedNormal);
