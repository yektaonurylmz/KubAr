Shader "MTE/Standard/5 Textures/VertexColored/NoFog"
{
	...
	CGINCLUDE
		...
		void MTE_SplatmapMix(Input IN, half4 defaultAlpha, out half4 splat_control, out half4 splat_control_extra, out half weight, out fixed4 mixedDiffuse)
		{
		...
		void surf(Input IN, inout SurfaceOutputStandard o)
		{
			...
			MTE_SplatmapMix(IN, defaultSmoothness, splat_control, splat_control_extra, weight, mixedDiffuse);
